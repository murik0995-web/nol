...
test('catalog is sane', () => {
  ...
  for (const p of cat) {
    ...
    assert.ok(['crm', 'desk', 'people', 'orgchart', 'hiring', 'wiki', 'tasks', 'goals', 'standups', 'quotes', 'invoices', 'contracts', 'expenses', 'timesheets', 'inventory', 'assets', 'meetings', 'subscriptions', 'leave', 'retros', 'roadmap', 'changelog', 'onboarding'].includes(p.cat), p.slug);
