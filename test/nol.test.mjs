...
test('catalog is sane', () => {
  ...
  for (const p of cat) {
    ...
    assert.ok(['crm', 'desk', 'people', 'hiring', 'wiki', 'tasks', 'goals', 'quotes', 'invoices', 'contracts', 'expenses', 'timesheets', 'inventory', 'assets', 'meetings', 'subscriptions'].includes(p.cat), p.slug);
