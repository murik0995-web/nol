...
const CLAIM_FORMS = [
  ...
  // Целым словом: без границ /iu ловил «Гость» и «Гостиница» (NOL-111 встал на REVIEW 25.09).
  // \b для кириллицы не работает, поэтому границы по \p{L}, как у «статьи» выше.
  [/(^|[^\p{L}])(ГОСТ|СанПиН|СНиП|ОКВЭД)(?!\p{L})/iu, 'ссылка на норматив'],
