...
const urls = [BASE, BASE + 'unsubscribe.html', BASE + 'factory.html', BASE + 'alt/', ...Object.keys(APP).map(k => BASE + `apps/${k}.html`), ...cat.map(p => BASE + `alt/${p.slug}/`)];
